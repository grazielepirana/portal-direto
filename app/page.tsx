    ...
    <main className="min-h-screen bg-[#F8FAFC] px-4 pb-8 pt-0 sm:px-6 lg:px-8">
      <div className="mx-auto w-full max-w-[1200px] space-y-10">
        ...
        >
          ...
          <div className="mx-auto grid w-full max-w-[1200px] grid-cols-1 items-stretch gap-8 px-4 sm:px-6 lg:grid-cols-[minmax(0,1.25fr)_minmax(0,0.75fr)] lg:px-8">
          <section
          ...
          <section
            id="home-search"
            className="!mt-0 rounded-[24px] bg-white/95 p-6 backdrop-blur-sm lg:ml-auto lg:max-w-[500px]"
